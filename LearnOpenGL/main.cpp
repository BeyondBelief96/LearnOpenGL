...
float lastX = get_window_width() / 2.0f;
float lastY = get_window_height() / 2.0f;
...
int main()
{
    ...
    Shader lightCubeShader("lightingShader.vs", "lightingShader.fs");

    //first configure the cubes VOA (and VBO)
